...
class DetectCycleUndirected {
    static boolean isCyclic(ArrayList<ArrayList<Integer>> adjacency, int numberOfVertices) {
        ...
        while (start < numberOfVertices) {
            ...
            reuseSeen.clear();
            BitSet returned = dfs(adjacency, start, -1, reuseSeen, visited);
            if (returned == null)
                return true;
    ...
    static BitSet dfs(ArrayList<ArrayList<Integer>> adjacency, int current, int from, BitSet seen, BitSet visited) {
        ...
        if (!visited.get(current)) {
            ...
            for (int connection : connections) {
                ...
                BitSet returned = dfs(adjacency, connection, current, seen, visited);
...
//        String edges = "45 16 54 29 12 41 36 13 9 31 49 52 46 53 22 4 8 11 35 19 11 54 22 47 30 37 42 53 44 47 54 28 4 47 59 19 29 35 32 39 5 23 32 51 17 55 57 25 7 31 46 18 26 8 6 57 45 50 51 30 37 47 60 43 35 59 1 4";
        int nodes = 4;
        String edges = "0 1 1 0 1 2 2 1 0 1";
